...
export default function PlatformAdminPanel({
  ...
  const [activeView, setActiveView] = useState<
    "overview" | "organizations" | "users" | "analytics" | "billing"
  >("overview");
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                ...
                {activeView === "paid-orgs" &&
                  "Organizations with active subscriptions and payments"}
                {activeView === "users-orgs" &&
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div>
                        <p className="text-sm text-gray-900">
                          Average Programs per Organization
                        </p>
                        <p className="text-xl text-gray-500">
                          {stats.totalOrganizations > 0
                            ? (
                                stats.totalPrograms / stats.totalOrganizations
                              ).toFixed(1)
                            : "0"}
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div>
                        <p className="text-sm text-gray-900">
                          Average Certificates per Organization
                        </p>
                        <p className="text-xl text-gray-500">
                          {stats.totalOrganizations > 0
                            ? (
