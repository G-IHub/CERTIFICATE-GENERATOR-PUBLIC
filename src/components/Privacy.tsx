      ...
      <div className="flex-1 flex justify-center py-16 px-4 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl w-full bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-3xl shadow-xl border border-white/50 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="mb-10 border-b border-gray-100 pb-8">
            ...
            <p className="text-lg text-gray-500">Last updated: April 2026</p>
          </div>

          <div className="prose prose-lg prose-gray max-w-none">
            <p className="text-gray-600 leading-relaxed mb-8 text-lg">
              This Privacy Policy explains how Genomac Innovation Hub collects
              and uses personal data. We respect your privacy and handle your
              data responsibly.
            </p>
            ...
            <div className="space-y-8">
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  We collect account information and data you provide when using
                  the service.
                </p>
              </section>
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  We use data to operate and improve the service, and to
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  We retain personal data as required to provide the service and
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  ...
                  or to perform service-related operations. These third parties
                  have access to your personal data only to perform these tasks
                  on our behalf.
                </p>
              </section>
            ...
            <div className="mt-12 p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
              ...
              <p className="text-blue-700">
                Contact support for privacy-related requests or data deletion
                inquiries.
              </p>
            </div>
          </div>
