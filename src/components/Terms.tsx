        ...
        <div className="max-w-4xl w-full bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-3xl shadow-xl border border-white/50 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="prose prose-lg prose-gray max-w-none">
            <p className="text-gray-600 leading-relaxed mb-8 text-lg">
              These Terms of Service ("Terms") govern your use of Certifyer.
              Please read them carefully. By using the service you agree to
              these terms.
            </p>
            ...
            <div className="space-y-8">
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  You are responsible for content you create and distribute
                  using Certifyer.
                </p>
              </section>
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  To the extent permitted by law, Genomac Innovation Hub is not
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  ...
                  creating an account. You are solely responsible for the
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  ...
                  functionality are owned by Genomac Innovation Hub and are
              ...
              <section className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors duration-300">
                ...
                <p className="text-gray-600 leading-relaxed pl-10">
                  ...
                  use our service after any revisions become effective, you
            ...
            <div className="mt-12 p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
              ...
              <p className="text-blue-700">
                For full terms or any inquiries, please contact our support
                team.
              </p>
            </div>
          </div>
