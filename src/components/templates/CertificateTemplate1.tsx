  ...
  return (
    ...
    >
      <div
        ...
        className="shadow-sm rounded flex justify-center w-[800px] h-150 p-10"
      >
        ...
        <div className="absolute top-10 left-10 z-40 flex justify-center items-center">
          ...
          <div className="flex flex-col">
            <p className="m-0 font-bold text-2xl tracking-wider">
        ...
        <div className="flex flex-col justify-center items-center text-center gap-8 mt-10">
          {/* Certificate Title */}
          <div>
