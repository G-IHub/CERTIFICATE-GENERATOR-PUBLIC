...
-- Policy: Authenticated users can view all blog posts (for admin panel)
...
-- Policy: Authenticated users can insert blog posts (platform admin)
...
-- Policy: Authenticated users can update blog posts (platform admin)
...
-- Policy: Authenticated users can delete blog posts (platform admin)
